<template>
    <div class="container mt-4 mb-5">
        <h2 class="section-title">Beneficiary Account <small>Create an account</small></h2>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form @submit.prevent="saveBeneficiaryAccount">
                    <!-- Display Text Field -->
                    
                    <div class="form-group mb-3 row">
                        <label class="form-label col-sm-2" for="displayText">Display Text: *</label>
                        <div class="col-sm-10">
                            <input type="text" v-model="beneficiaryAccount.displayText" class="form-control" id="displayText" placeholder="Enter a display name for the account" required>
                        </div>   
                    </div>
                    ...
                    <div class="form-group mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select v-model="beneficiaryAccount.accountCategory" class="form-control" id="category" required>
                    ...
                    <div class="form-group mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" v-model="beneficiaryAccount.numberOfAuthorizer" class="form-control" id="displayText" placeholder="Specify the number of authorisations required for this account or leave blank to use global firm number">
                        </div>   
                    </div>
                    ...
                    <div class="form-group mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" v-model="beneficiaryAccount.accountNumber" class="form-control" id="accountNumber" placeholder="Enter the account number" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" v-model="beneficiaryAccount.accountHolderType" id="natural" value="natural">
                                <label class="form-check-label" for="natural">Natural Person</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" v-model="beneficiaryAccount.accountHolderType" id="juristic" value="juristic">
                    ...
                    <div class="mb-0 row form-group">
                        ...
                        <label for="account_holder" class="form-label col-sm-2" v-if="this.beneficiaryAccount.accountHolderType == 'juristic'">Company Name: *</label>
                        <div class="col-sm-10 mb-2" v-if="this.beneficiaryAccount.accountHolderType == 'juristic'">
                            <input type="text" v-model="beneficiaryAccount.companyName" class="form-control" id="companyName" placeholder="Enter the name of the Company">
                        </div>
                        
                    </div>
                    
                    <div class="mb-2 row form-group" v-if="this.beneficiaryAccount.accountHolderType == 'natural'">
                        <label for="id_number" class="form-label col-sm-2">ID No. / Passport No.:</label>
                        <div class="col-sm-10">
                            <input type="text" v-model="beneficiaryAccount.idNumber" class="form-control" placeholder="Enter ID Number or leave blank if not known">
                        </div>
                    </div>
                    <div class="mb-2 row form-group" v-if="this.beneficiaryAccount.accountHolderType == 'juristic'">
                        <label for="id_number" class="form-label col-sm-2">Registration #.:</label>
                        <div class="col-sm-10">
                            <input type="text" v-model="beneficiaryAccount.registrationNumber" class="form-control" id="registrationNumber" placeholder="Enter the registration number or leave blank if not applicable">
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select v-model="beneficiaryAccount.accountType" class="form-control" id="accountType" required>
                    ...
                    <div class="form-group mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select v-model="beneficiaryAccount.institution.id" class="form-control" id="institution" required @change="onInstitutionChange">
                    ...
                    <div class="form-group mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" v-model="beneficiaryAccount.myReference" class="form-control" id="myReference" placeholder="My reference to use when making aggregated payments to this account">
                        </div>
                    </div>
                    <div class="form-group mb-3 row">
                        <label class="form-label col-sm-2" for="recipientReference">Recipient Reference:</label>
                        <div class="col-sm-10">
                            <input type="text" v-model="beneficiaryAccount.recipientReference" class="form-control" id="recipientReference" placeholder="Recipient's reference to use when making aggregated payments to this account">
                        </div>
                    </div>
                    <div class="form-group mb-3 row">
                    ...
                    <div class="form-group mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" v-model="beneficiaryAccount.emailAddress" class="form-control" id="emailAddress" placeholder="Enter the email address">
                        </div>
                    </div>
                    <div class="form-group mb-3 row">
                        <label class="form-label col-sm-2" for="phoneNumber">Phone Number:</label>
                        <div class="col-sm-10">
                            <input type="text" v-model="beneficiaryAccount.phoneNumber" class="form-control" id="phoneNumber" placeholder="Enter the phone number e.g +27767676787">
                        </div>
                    </div>
                    <div class="form-group mb-3 row">
...
export default {
    ...
    methods: {
        ...
        onInstitutionChange() {
           ...
           const selectedInstitution = this.institutions.find(institution => institution.id === this.beneficiaryAccount.institution.id);
           
           if (selectedInstitution) {
               this.beneficiaryAccount.branchCode = selectedInstitution.branch_code;
           } else {
               this.beneficiaryAccount.branchCode = ''; // Clear branch code if no institution is selected
           }
       },
        // Perform AVS Verification using Axios
        performAvsVerification() {
            axios.post('/api/avs/verify', {
                    account_number: this.beneficiaryAccount.accountNumber,
