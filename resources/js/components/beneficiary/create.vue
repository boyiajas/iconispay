            ...
            <div class="card-body">
                <form @submit.prevent="saveBeneficiaryAccount">
                    ...
                    <div class="form-group mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select v-model="beneficiaryAccount.category" class="form-control" id="category" required>
                    ...
                    <div class="form-group mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" v-model="beneficiaryAccount.accountHolderType" id="naturalPerson" value="Natural Person">
                                <label class="form-check-label" for="naturalPerson">Natural Person</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" v-model="beneficiaryAccount.accountHolderType" id="juristicPerson" value="Juristic Person">
                    ...
                    <div class="form-group mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select v-model="beneficiaryAccount.institutionId" class="form-control" id="institution" required>
    ...
    methods: {
        ...
        saveBeneficiaryAccount() {
            axios.post('/api/beneficiary-accounts', this.beneficiaryAccount)
                .then(response => {
                    alert('Beneficiary account created successfully!');
                    this.resetForm();
                })
                .catch(error => {
