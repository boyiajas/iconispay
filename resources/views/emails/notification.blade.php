    ...
    <table class="wrapper">
        <tr>
            <td class="header">
                ...
                <h2 style="margin-top:0px;padding-top:0px;">{{ $emailData['subject'] }}</h2>
            </td>
        </tr>
        <tr>
            <td class="content">
                ...
                <p>
                    <a href="{{ $emailData['url'] }}" style="padding: 10px 20px; background-color: #007bff; color: white; text-decoration: none; border-radius: 4px;">
                        View Requisition
                    </a>
                </p>
